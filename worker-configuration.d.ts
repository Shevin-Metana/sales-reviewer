/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 46ed56bbf1e5e619190dfd765988d7fc)
// Runtime types generated with workerd@1.20260317.1 2024-10-22 
declare namespace Cloudflare {
	...
	interface Env {
		...
		DB: D1Database;
		AI: Ai;
		CALL_REVIEW_WORKFLOW: Workflow<Parameters<import("./src/index").CallReviewWorkflow['run']>[0]['payload']>;
	}
}
